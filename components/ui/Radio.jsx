...
const Radio = ({
  ...
  value,
  onChange,
  activeClass = "ring-[#D8CCB2] dark:ring-slate-400",
  wrapperClass = " ",
      ...
      >
        ...
        <span
          ...
          ${
            checked
              ? activeClass +
                " ring-[6px]  ring-inset ring-offset-2 dark:ring-offset-slate-600  dark:ring-offset-4 border-[#D8CCB2]"
              : "border-[#D8CCB2] dark:border-slate-600 dark:ring-slate-700"
          }
          `}
        ></span>
