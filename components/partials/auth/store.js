...
export const handlelogin2 = createAsyncThunk(
  ...
  async (data,router, thunkAPI) => {
    ...
    // console.log(router)
    const response = await axios.post('https://my-krew-t2j4.onrender.com/api/users/login', data);
...
export const handleRegister2 = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    console.log(data)
    const response = await axios.post(`https://my-krew-t2j4.onrender.com/api/users`, data);
    console.log(response.data)
    return response.data;
  }
);
...
export const handleRegistretionStep1 = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    console.log(data)
    const response = await axios.post(`https://my-krew-t2j4.onrender.com/api/users/preRegistration/createPreRegistration1`, data,
    {
...
export const handleGetRegistrationByUserId = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    const token = localStorage.getItem('jwtToken');
    console.log(data)
    const response = await axios.get(`https://my-krew-t2j4.onrender.com/api/users/preRegistration/getPreregistration`,
    {
